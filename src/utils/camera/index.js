...
import { Video, Canvas, Wrapper, Container, Flash, Overlay } from 'utils/camera/styles';
    ...
    <Measure bounds onResize={handleResize}>
      {({ measureRef }) => (
        <Wrapper>
          ...
          {isVideoPlaying && (
            <Button variant='contained' className='mt-4' onClick={isCanvasEmpty ? handleCapture : handleClear}>
              {isCanvasEmpty ? 'Chụp' : 'Chụp ảnh khác'}
            </Button>
          )}
        </Wrapper>
      )}
